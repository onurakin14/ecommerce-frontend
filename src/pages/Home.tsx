...
function Home() {
  ...
  return (
    <React.Fragment>
      <main className="py-5 sm:py-8 lg:py-12 px-4 sm:px-6 lg:px-8">
        {/* Hero Section*/}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 flex flex-col gap-6 rounded-xl bg-gray-50 dark:bg-gray-900 p-6 @[864px]:flex-row @[864px]:items-center">
            <div className="flex flex-col gap-6 text-left @[864px]:w-1/2 @[864px]:justify-center">
              <div className="flex flex-col gap-4">
                <h1 className="text-gray-900 dark:text-white text-4xl font-black leading-tight tracking-tighter @[480px]:text-5xl">
                  Elevate Your Style
                </h1>
                <p className="text-gray-600 dark:text-gray-400 text-base font-normal leading-normal @[480px]:text-lg">
                  Discover our new collection of premium products designed to
                  fit your lifestyle. Quality and comfort in every piece.
                </p>
              </div>
              <Link
                to="/products"
                className="flex min-w-[84px] max-w-fit cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-6 bg-white text-dark text-base font-bold leading-normal tracking-wide shadow-sm hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-gray-900"
              >
                ...
                <div key={item.id}>
                  <div className="group flex flex-col h-full rounded-xl border border-gray-200 dark:border-gray-800 bg-background-light dark:bg-gray-900 shadow-subtle transition-shadow duration-300 hover:shadow-hover">
                    <div
                      ...
                      data-alt="High-fidelity wireless headphones in black"
                    ...
                    <div className="flex flex-col flex-1 justify-between p-4 gap-4">
                      ...
                      <button
                        ...
                        className="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 text-sm font-bold leading-normal tracking-wide hover:bg-gray-200 dark:hover:bg-gray-700"
                      >
              ...
              return (
                <div key={item.id}>
                  <div className="group flex flex-col h-full rounded-xl border border-gray-200 dark:border-gray-800 bg-background-light dark:bg-gray-900 shadow-subtle transition-shadow duration-300 hover:shadow-hover">
                    <div
                      className="w-full bg-center bg-no-repeat aspect-square bg-cover rounded-t-xl"
                      data-alt="Modern ergonomic office chair"
                      style={{ backgroundImage: `url(${item.image})` }}
                    ></div>
                    <div className="flex flex-col flex-1 justify-between p-4 gap-4">
                      <div>
